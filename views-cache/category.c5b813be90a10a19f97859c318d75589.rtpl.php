            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add">Adicionar no Carinho</a>
                    </div>                       
                </div>
            </div>
            <?php } ?>
